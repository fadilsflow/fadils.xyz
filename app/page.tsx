...
const WorkExperienceItem = memo(({ job }) => (
  <a
    ...
    <>
      ...
      <article className="flex-1 space-y-8">
        ...
        <section aria-labelledby="products-heading">
          <h2 id="products-heading" className="mb-5 text-lg font-medium">
            Products
          </h2>
          {renderProducts}
        </section>
        ...
        <section aria-labelledby="skills-heading">
          <h2 id="skills-heading" className="mb-5 text-lg font-medium">
            Technical skills
          </h2>
          {renderSkills}
        </section>
        ...
        <section aria-labelledby="experience-heading">
          <h2 id="experience-heading" className="mb-5 text-lg font-medium">
            Work Experience
          </h2>
        ...
        <section aria-labelledby="blog-heading">
          <h2 id="blog-heading" className="mb-3 text-lg font-medium">
            Blog
          </h2>
          {renderBlogPosts}
        </section>
        ...
        <section aria-labelledby="connect-heading">
          <h2 id="connect-heading" className="mb-5 text-lg font-medium">
            Connect
          </h2>
